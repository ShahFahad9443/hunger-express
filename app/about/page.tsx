...
export const metadata: Metadata = {
  title: "About Us | Hunger Express Peshawar",
  description:
    "Learn about our story, mission, and the team behind Hunger Express",
};
        ...
        <section className="bg-primary text-white py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              A cozy retreat in the heart of Peshawar, where exceptional coffee
              ...
              <div className="text-center">
                <div className="rounded-full overflow-hidden w-48 h-48 mx-auto mb-4">
                  <img
                    ...
                    alt="Shah Fahad - Founder & CEO"
                    className="w-full h-full object-cover"
                  />
                </div>
                <h3 className="text-xl font-semibold">Shah Fahad</h3>
                <p className="text-primary mb-2">Founder & CEO</p>
                <p className="text-gray-600 max-w-sm mx-auto">
                  With over 15 years in the hospitality industry, Shah Fahad brings
                  his passion for exceptional service to Hunger Express.
                </p>
              </div>
              <div className="text-center">
                <div className="rounded-full overflow-hidden w-48 h-48 mx-auto mb-4">
                ...
                <div className="relative">
                  <div className="flex items-center justify-center">
                    ...
                    <div className="w-1/2 pr-8 text-right">
                      ...
                      <p className="text-gray-600">
                        Hunger Express opens its doors in Peshawar
                      </p>
                    </div>
                ...
                <div className="relative">
                  <div className="flex items-center justify-center">
                    ...
                    <div className="w-1/2 pl-8">
                      ...
                      <p className="text-gray-600">
                        Opened our second location in University Road, Peshawar
                      </p>
                    </div>
                  </div>
                </div>
