            ...
            <tr>
              <td style="padding: 30px;">
                ...
                <div style="margin: 30px 0; text-align: center;">
                  <a href="https://hunger-exprees.vercel.app/dashboard" style="background-color: ${
                    meta.color
                ...
                ${
                  forEmail.status === "cancelled"
                    ? `<div style="background-color: #ffe0e0; color: #a94442; padding: 15px; border-radius: 6px;">
                        <strong>Need help?</strong> This order was cancelled. If you didn’t expect this, please <a href="mailto:shahfahad9443477@gmail.com">contact support</a>.
                      </div>`
                    : ""
                }

                <p style="font-size: 14px; color: #999;">Thanks again for ordering with Hunger Express!</p>
              </td>
            </tr>
            <tr>
              <td align="center" style="background-color: #f4f4f4; padding: 20px; font-size: 12px; color: #999;">
                ©️ ${new Date().getFullYear()} Hunger Express. All rights reserved.
              </td>
            </tr>
          </table>
        </td>
