...
export const metadata: Metadata = {
  title: "Blog Post | Hunger Express Peshawar",
...
export default function BlogPostPage({ params }: { params: { slug: string } }) {
  ...
  const post = {
    ...
    content: `
      <p>Coffee brewing is both an art and a science. At Hunger Express, our baristas have perfected the craft of brewing the perfect cup of coffee. In this article, we'll share some of their secrets with you.</p>
      
      <h2>The Importance of Fresh Beans</h2>
      <p>The journey to a perfect cup of coffee begins with the beans. Always use freshly roasted beans, ideally within two weeks of their roast date. At Hunger Express, we source our beans from sustainable farms and roast them in small batches to ensure maximum freshness.</p>
      ...
      <p>Beyond these technical aspects, there's an intuitive element to coffee brewing that comes with experience. Our baristas at Hunger Express have developed a feel for when a coffee is brewing perfectly, often making subtle adjustments based on factors like humidity and bean freshness.</p>
      
      <p>We invite you to visit Hunger Express to experience the results of our baristas' expertise firsthand. And if you're passionate about coffee, ask questions! Our team loves sharing their knowledge with fellow coffee enthusiasts.</p>
    `,
  }
