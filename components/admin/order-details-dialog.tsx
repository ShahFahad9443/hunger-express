  ...
  const handlePrintPDF = () => {
    ...
    const printContent = `
      ...
      <html>
        ...
        <body>
          <div class="header">
            <div class="cafe-name">Hunger Express</div>
            <div class="cafe-info">
              📞 +92 51 1234567 | 📧 info@hungerexpress.com<br>
          ...
          <div style="text-align: center; margin-top: 30px; font-size: 12px; color: #666;">
            Thank you for choosing Hunger Express!<br>
                  ...
                  {order.orderType === "pickup" && (
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-medium">
                          {order.orderTypeDisplay || "University Road, Peshawar"}
                        </p>
                      </div>
                    </div>
                  )}
