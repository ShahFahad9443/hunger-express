...
const instagramPosts = [
  {
    id: 1,
    image: "/insta1.jpg?height=300&width=300",
    likes: 202,
    comments: 4,
    href: "https://www.instagram.com/p/DXPndHLkuOF/",
  },
  {
    id: 2,
    image: "/insta2.jpg?height=300&width=300",
    likes: "4,962",
    comments: 231,
    href: "https://www.instagram.com/p/DXPmHJ-kg1Q/",
  },
  {
    id: 3,
    image: "/insta3.jpg?height=300&width=300",
    likes: "12.6k",
    comments: 79,
    href: "https://www.instagram.com/p/DXPlKF9EvKx/",
  },
  {
    id: 4,
    image: "/insta4.jpg?height=300&width=300",
    likes: 116,
    comments: 5,
    href: "https://www.instagram.com/p/DXPlKF9EvKx/",
  },
    ...
    <section className="py-20 bg-secondary" ref={ref}>
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-10">
          <a
            href="https://www.instagram.com/hungerexpress2026"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center"
          >
            <Button className="bg-primary hover:bg-primary/90">
              <Instagram className="mr-2 h-4 w-4" /> Follow Hunger Express
            </Button>
          </a>
        </div>
      </div>
